...
const DeathAdder = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/razer-viper.png?v=1670972557182';
const Kaira = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/razer-headset.png?v=1670972564920';
           ...
           { joke && <Alert/> }
             <div className="centered-tasks">
                 ...
                 <form onSubmit={Task} className="container-vip">
                   ...
                   <img alt="razer-kaira" src={DeathAdder} width={105} className="level-one"/>
                   ...
                   <button className="button is-danger" disabled={wait}>Submit Task</button>
                   </div>     
                  </div>             
                </form> 
                ...
                <form onSubmit={Task} className="container-vip-t">
                   ...
                   <div className="container-td-vip">
                   <img alt="razer-mouse" src={Kaira} width={95} className="level-one"/>
                   <div className="container-semi-vip">
