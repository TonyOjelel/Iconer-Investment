                        ...
                        <div className="column is-4-desktop">
                            <form onSubmit={Register} className="box">
                                ...
                                <div className="field mt-5">
                                    ...
                                    <div className="controls">
                                        <input type="text" className="input" placeholder="user@email.com" value={email} onChange={(e) => setEmail(e.target.value)} />
                                    </div>
                                </div>
                                <div className="field mt-5">
                                ...
                                <div className="field mt-5">
                                  ...
                                  <div className="field mt-5">
                                    ...
                                    <div className="controls">
                                        <input type="" className="input" placeholder="Invitation Code" value={ref_code} onChange={(e) => setRef_Code(e.target.value)} />
                                    </div>
                                </div>
                                {joke && <div className="message is-danger"><h1 className="has-text-centered">{msg}</h1></div>}
                                <div className="field mt-5">
                                    <button disabled={wait} className="button is-danger is-fullwidth">Register</button>
                                </div>
                            </form>
                        </div>
                    </div>
