...
const Current = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/current.png?v=1670972338225';
...
const Avatar = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/avatar_default.jpg?v=1670271759257';
const Arrow = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/arrow-slide.png?v=1670271756950';
const Wallet = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/wallet-outline.png?v=1670271834320';
const Config = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/settings-outline.png?v=1670271784774';
const Security = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/key-outline.png?v=1670271775178';
const RRecord = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/card-recharge-outline.png?v=1670271760791';
const WRecord = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/card-withdraw-outline.png?v=1670271763239';
...
const Task = 'https://cdn.glitch.global/c58699df-f192-4af9-bca5-0e1daf50c2f9/receipt-outline.png?v=1670271782979';
    ...
    return (
        ...
        <div className="hero has-background-grey-light is-fullheight is-fullwidth">
             ...
             <div className="containerdata">  
              ...
              <img alt="avatar" className="photoavatar" src={Avatar} width={50}/>
              </div>
               ...
               <img alt="sync" className="sync-logo" src={Sync} width={30} onClick={refreshToken}/>
             </div>
             ...
             <div className="methods3">
              ...
              <h1 className="subassets arrow-red">Vip Level: { level ? vip : 'null' }</h1>
             </div>
             ...
             <Link to="/personal">
               <div className="methods2">
                   <img className="personal-red" alt="personal" src={Config} width={25}/>
             ...
             <hr className="solid"/>
               <Link to="/security">
               <div className="methods2">
                   <img className="security-red" alt="security" src={Security} width={25}/>
            ...
            <hr className="solid"/>
             <Link to="/withdraws/record">
               <div className="methods2">
                   <img className="withdraw-red" alt="withdraw" src={WRecord} width={25}/>
             ...
             <hr className="solid"/>
              <Link to="/recharges/record">
               <div className="methods2">
                   <img className="recharge-red" alt="recharge" src={RRecord} width={25}/>
